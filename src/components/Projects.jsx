  ...
  <div className="grid-container">
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>In this application, a user searches a city and both the current and 5 day forecast
          information is displayed by calling an API for data.<a href="https://github.com/villettec/M6C-Weather_Dashboard"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>Via prompts, a user chooses whether to include symbols, numbers, or letters in a generated
          password of their choice of length.<a href="https://github.com/villettec/M3C-Password_Generator"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>This application is a timed quiz displaying array questions and answers. Ordered high scores
          and saved initials are featured at the end.<a href="https://github.com/villettec/M4C-Code_Quiz"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>In this day planner, moments and jquery are used to show events of the past, present, and
          future which the user can enter and erase.<a href="https://github.com/villettec/M5C-Work_Day_Scheduler"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>This was an exercise in code refactoring to make the code apply to accessibility standards
          and SEO optimization.<a href="https://github.com/villettec/M1C-Horiseon_Refactor/"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
    ...
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>This is a node application which prompts the user with input questions and generates a
          README. A walkthrough video is above.<a href="https://github.com/villettec/M9C-Readme_Generator"> Repo</a>.</p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>This node application prompts the user with questions about employees and generates a HTML
          and CSS page. A walkthrough video is above. <a href="https://github.com/villettec/M10C-Team_Profile_Generator"> Repo</a>.</p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        <h3>Note Taker</h3>
        <p>This full stack express application allows the user to write and save notes which uses the express server to write and retrieve them from a database file.<a href="https://github.com/villettec/M11C-Note_Taker"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
    ...
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>An Express.js API is configured to use Sequelize to interact with a MySQL database. A walkthrough video is above.<a href="https://github.com/villettec/M13C-E-commerce_Back_End"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        <h3>Tech Blog</h3>
        <p>This full-stack website allows a user to login and post new blog posts or comment on them.<a href="https://github.com/villettec/M14C-Tech_Blog"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        <h3>Gator Tracker</h3>
        <p>This collaborative full-stack project allows users to post local neighborhood alligator sightings in the southeast United States.<a href="https://github.com/villettec/Gator_Aid"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <p>This social network api allows users to post/edit/delete thoughts, reactions, and friends using Express.js for routing, MongoDB database, and Mongoose ODM.<a href="https://github.com/villettec/M18C-Social_Network_API"> Repo.</a></p>
      </div>
    </div>
    <div className="project-container">
