...
const Projects = () => {
  ...
  <div className="grid-container">
    <div className="project-container">
      <a href="https://villette0.github.io/M6C-Weather_Dashboard/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="project-description">
        ...
        <p>In this front-end site, a user searches a city and both the current and 5 day forecast
          ...
          <a href="https://github.com/villette0/M6C-Weather_Dashboard" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
      <a href="https://villette0.github.io/School_Resources/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="project-description">
        ...
        <a href="https://github.com/villette0/School_Resources" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
      <a href="https://villette0.github.io/M4C-Code_Quiz/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="project-description">
        ...
        <p>This front-end website application is a timed quiz displaying array questions and answers. Ordered high scores
          ...
          <a href="https://github.com/villette0/M4C-Code_Quiz" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
    ...
    <div className="project-container">
      ...
      <div className="project-description">
        ...
        <a href="https://github.com/villette0/M14C-Tech_Blog" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
    ...
    <div className="project-container">
      <a href="https://villette0.github.io/M3C-Password_Generator/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="project-description">
        ...
        <a href="https://github.com/villette0/M3C-Password_Generator" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
      <a href="https://villette0.github.io/JS-To_Do_List/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="project-description">
        ...
        <p>This front end To Do List website application enables a user to input tasks and mark them as completed which
          ...
          <a href="https://github.com/villette0/JS-To_Do_List/" target="_blank" rel="noopener noreferrer"> Repo</a></b></p>
      </div>
    </div>
    <div className="project-container">
    ...
    {/* <div className="project-container">
      <a href="https://villette0.github.io/M5C-Work_Day_Scheduler/" target="_blank" rel="noopener noreferrer">
    ...
    <div className="project-container">
      <a href="https://villette0.github.io/M1C-Horiseon_Refactor/" target="_blank" rel="noopener noreferrer">
